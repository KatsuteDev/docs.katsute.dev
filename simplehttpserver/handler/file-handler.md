...
The [`FileHandler`](/simplehttpserver/javadoc/simplehttpserver/com/kttdevelopment/simplehttpserver/handler/FileHandler.html) is used to deploy files or directories to the server. The response that is sent to the user can be modified using [adapters](#file-handler-adapter).

# File Handler Adapter

A [`FileHandlerAdapter`](/simplehttpserver/javadoc/simplehttpserver/com/kttdevelopment/simplehttpserver/handler/FileHandlerAdapter.html) can be used to determine what the server will sent to client and what context the file will be located at.
...
The [byte loading option](/simplehttpserver/javadoc/simplehttpserver/com/kttdevelopment/simplehttpserver/handler/ByteLoadingOption.html) enum parameter determines how files will be stored on the server.
